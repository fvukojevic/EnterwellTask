...
?>
    ...
    <div style="position: fixed; top: 0px; left: 0px; right: 0px; bottom: 0px; overflow: hidden auto; z-index: -1; background: rgba(20, 20, 20, 0.8); opacity: 1;" id="success-alert">
        <div class="hidden-success">
            ...
            <button type="submit" class="ok-button" style="border: 0; background: transparent">
                <img id="success-img" src="wp-content/themes/enterwellTask/assets/ok-button.svg"
                     style="cursor:pointer;">
            </button>
        </div>
    </div>
    <div style="position: fixed; top: 0px; left: 0px; right: 0px; bottom: 0px; overflow: hidden auto; z-index: -1; background: rgba(20, 20, 20, 0.8); opacity: 1;" id="error-alert">
        <div class="hidden-error">
            ...
            <button type="submit" class="error-button" style="border: 0; background: transparent">
                <img id="error-img" src="wp-content/themes/enterwellTask/assets/error-button.svg"
                     style="cursor:pointer;">
            </button>
        </div>
    </div>
            ...
            <form id="form" enctype="multipart/form-data" method="POST"
                ...
                <div id="drop-area" class="dragdrop-rectangle">
                    ...
                    <img id="upload-icon" class="upload-icon"
                         src="wp-content/themes/enterwellTask/assets/upload-icon.svg">
                ...
                <div class="input1 regular-inputs">
                    <input name="bill_number" class="input-text-shared input1-text validator"
                ...
                <fieldset class="input5 regular-inputs">
                    <input name="house_number" class="input-text-shared input5-text validator"
                ...
                <fieldset class="input7 regular-inputs">
                    <input name="zip_code" class="input-text-shared input7-text validator"
                ...
                <fieldset class="input9 regular-inputs">
                    <input name="contact" type="text" class="input-text-shared input9-text validator"
                ...
                <fieldset class="input10 regular-inputs">
                    <input name="email" type="email" class="input-text-shared input10-text validator"
                           placeholder="Email*">
